...
WORKDIR /.mpi
RUN apt-get update -y && apt-get install -y wget openmpi-bin libopenmpi-dev
# # install openMPI
...
# ENV PATH /.mpi/openmpi-3.0.0/bin:$PATH
# ENV LD_LIBRARY_PATH /.mpi/openmpi-3.0.0/lib:$LD_LIBRARY_PATH
